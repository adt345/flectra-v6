...
class MarelinSampleMarketing(models.Model):
    ...
    standar = fields.Selection(string=u'Standar/Acuan',selection=[
        ...
        ('Work_Sheet', 'Crew'),
        ('Approval_From_Marel', 'Approval_From_Marel'),])
        
    komposisi_material = fields.Text(string='komposisi_material',)
    ...
    hell_stretch_x= fields.Char(string='Hell Stretch x ',)
    hell_stretch_y= fields.Char(string='Hell Stretch y ',)
    hell_relaxed_x= fields.Char(string='Hell Relaxed x ',)
    hell_relaxed_y= fields.Char(string='Hell Relaxed y ',)
